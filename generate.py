...
def generate():
    ...
    draw_rect(aesthetic, 233, 144, 89, 89, palette['S3'])
    draw_rect(aesthetic, 178, 144, 55, 55, palette['S4'])
    draw_rect(aesthetic, 178, 199, 34, 34, palette['S5'])
    draw_rect(aesthetic, 212, 199, 21, 21, palette['S6'])
    draw_rect(aesthetic, 212, 186, 13, 13, palette['S7'])
    draw_rect(aesthetic, 204, 186, 8, 8, palette['S8'])
    draw_rect(aesthetic, 204, 194, 5, 5, palette['S9'])
    draw_rect(aesthetic, 209, 194, 3, 3, palette['S10'])
